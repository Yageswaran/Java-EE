 ...
 */
public class Rngs {
	public static final int MODULUS =    2147483647; /* DON'T CHANGE THIS VALUE                  */
	public static final int MULTIPLIER = 48271;      /* DON'T CHANGE THIS VALUE                  */
	public static final int CHECK =      399268537;  /* DON'T CHANGE THIS VALUE                  */
	public static final int STREAMS =    256;        /* # of streams, DON'T CHANGE THIS VALUE    */
	public static final int A256 =       22925;      /* jump multiplier, DON'T CHANGE THIS VALUE */
	public static final int DEFAULT =    123456789;  /* initial seed, use 0 < DEFAULT < MODULUS  */
	 ...
	 * ---------------------------------------------------------------------
	 */
	public static void PlantSeeds(long x)
	{
	 ...
	 * ---------------------------------------------------------------
	 */
	public static  void PutSeed(long x)
	{
	    boolean ok = false;
	    ...
	    if (x < 0)
	        x = cale.getTimeInMillis() % MODULUS;
	    ...
	    if (x == 0){
	        while (ok) {
	            ...
	            try {
					x = Long.parseLong(b1.readLine());
				} catch (NumberFormatException nfe){
					System.out.println("NumberFormatException ERROR:" + nfe.getMessage());
				} catch (IOException e) {
	 ...
	 * ------------------------------------------------------------------
	 */
	public static void SelectStream(int index)
	{
		long idx = (long)index & 0xFFFFFFFFL;
	    stream = (int) ((idx % STREAMS) & 0xFFFFFFFFL);
