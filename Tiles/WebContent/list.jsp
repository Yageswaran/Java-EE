...
<body>
	<form name="HiddenForm" action="File.do?method=download" method="post">
	...
	<%
		File folder = new File(
				"C:\\Users\\yageswaran.ramar\\workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\Tiles\\upload\\");
		File[] listOfFiles = folder.listFiles();

		for (int i = 0; i < listOfFiles.length; i++) {
	%>

	<form action="File.do?method=download" method="post">
		<table border="1">
